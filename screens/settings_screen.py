...
class SettingsScreen(Screen):
    """
    หน้าตั้งค่า — ตั้งเบอร์ PromptPay ฮาฏ และใช้ QR Code สำหรับรับเงิน
    Data persistence: แบบ JSON (ไฟล์ settings.json) ผ่าน Kivy JsonStore
    """

    def on_enter(self, *args):
        """โหลดเบอร์ PromptPay จาก settings.json เพื่อแสดงใน input field"""
    ...
    def save_promptpay(self):
        """บันทึกเบอร์ PromptPay ลง settings.json ทันทีเมื่อปิด keyboard หรือ unfocus"""
